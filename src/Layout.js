  ...
  return (
    <SidebarProvider>
      ...
      <div className="min-h-screen flex w-full bg-[#0a0a0a]">
        <Sidebar className="w-80 min-h-screen flex-shrink-0 border-r border-zinc-800 bg-zinc-900 text-zinc-100">
          <SidebarHeader className="border-b border-zinc-800 p-6 bg-zinc-900">
            <div className="flex items-center gap-4">
              <img
                src="/images/axon-logo.svg"
                alt="Axon Labs"
                className="w-14 h-14 object-contain rounded-md bg-zinc-800 p-1"
              />
              <div>
                <h2 className="font-extrabold text-white text-2xl tracking-tight uppercase">AXON TRANSPORT</h2>
                <p className="text-sm text-zinc-400 uppercase tracking-widest mono">FLEET SAFETY SYSTEMS</p>
              </div>
            </div>
          </SidebarHeader>
          
          <SidebarContent className="p-2 bg-zinc-900">
    {/* NEW GROUP: FLEET MANAGEMENT */}
    <SidebarGroup>
      ...
      <SidebarGroupContent>
        <SidebarMenu>
          {/* Dashboard, Drivers (Pages that are purely management/overview) */}
    ...
    {/* NEW GROUP: SAFETY & RISK ANALYSIS */}
    <SidebarGroup className="mt-6">
      ...
      <SidebarGroupContent>
        <SidebarMenu>
          {/* Alerts, Analytics, AI Recommendations (Pages focused on risk and data analysis) */}
    ...
    {/* EXISTING FLEET STATUS GROUP (Follows the new groups) */}
    <SidebarGroup className="mt-6">
      <SidebarGroupLabel className="text-[10px] font-semibold text-zinc-500 uppercase tracking-widest px-3 py-3 mono">
        FLEET STATUS
      </SidebarGroupLabel>
